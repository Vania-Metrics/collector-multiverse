...
// from a sibling directory. The repo is cloned into .gradle/vania-core and
// included as a composite build: "fr.samflix:vania-metrics-api" is compiled
// from its sources, at that exact ref.
//
...
rootProject.name = "colecteur-multiverse"
