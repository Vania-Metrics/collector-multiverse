// colecteur-multiverse — a VaniaMetrics-<Name>-<v>.jar in build/libs/
//
...
tasks.withType<JavaCompile>().configureEach {
    // --release 21: the lobby targets Java 25, the proxy Java 21. The smaller wins.
    options.release = 21
...
// repo's list identifies modules by their plugin name. A single source, the
// one Bukkit displays.
